...
(3, 3, 'David Brown', '456-789-1230'),
(4, 4, 'Emily Johnson', '789-123-4560'),
(5, 5, 'Michael Wilson', '321-654-9870'),
(6, 6, 'Sarah Davis', '654-987-3210'),
(7, 7, 'Robert Miller', '987-321-6540'),
(8, 8, 'Lisa Taylor', '159-487-2630'),
(9, 9, 'Christopher Martinez', '753-951-8640'),
(10, 10, 'Jennifer Garcia', '369-258-1470');
...
(1, 1, 'Summer Sale 2023', '2023-06-01', '2023-08-31', 10000.00),
(2, 2, 'Year-End Clearance', '2023-11-01', '2023-12-31', 15000.00),
(3, 3, 'Spring Specials', '2023-03-01', '2023-05-31', 12000.00),
(4, 4, 'Black Friday Deals', '2023-11-24', '2023-11-26', 20000.00),
(5, 5, 'Holiday Savings', '2023-12-15', '2023-12-31', 18000.00),
(6, 6, 'Back to School Sale', '2023-08-15', '2023-09-15', 8000.00),
(7, 7, 'Winter Wonderland', '2023-12-01', '2024-01-31', 17000.00),
(8, 8, 'New Year Clearance', '2023-12-31', '2024-01-15', 12000.00),
(9, 9, 'Spring Break Deals', '2023-03-15', '2023-03-31', 10000.00),
(10, 10, 'Labor Day Sale', '2023-09-01', '2023-09-04', 9000.00);
...
(1, 1, 'Bank Loan', 'Financing option provided by partnered banks', 'Fixed interest rate, flexible repayment terms'),
(2, 2, 'Credit Card', 'Financing option for immediate payment using credit cards', 'Various interest rates based on card issuer'),
(3, 3, 'Lease', 'Long-term lease agreement with monthly payments', 'Fixed monthly payment for a specified term'),
(4, 4, 'In-House Financing', 'Financing option provided directly by the dealership', 'Customizable terms based on customer needs'),
(5, 5, 'Cash', 'Payment made in full at the time of purchase', 'No interest or repayment terms'),
(6, 6, 'Personal Loan', 'Loan option for individuals from financial institutions', 'Flexible repayment terms and interest rates'),
(7, 7, 'Manufacturer Financing', 'Financing provided by the car manufacturer', 'Special promotional rates and incentives'),
(8, 8, 'Home Equity Loan', 'Loan option secured by the borrower''s home equity', 'Lower interest rates and longer repayment terms'),
(9, 9, 'Peer-to-Peer Lending', 'Online platform for borrowing from individual investors', 'Varied interest rates based on borrower''s creditworthiness'),
(10, 10, 'Line of Credit', 'Revolving credit facility with predetermined credit limit', 'Interest charged on outstanding balance only');
